...
from models import Person, Camera, Track
...
def get_images_for_person(id):
    ...
    images_list = [{'img': 'http://127.0.0.1:5000/static/images/' + str(image)} for image in images]
    print(images_list)
...
def edit_track(id):
    ...
    ## TODO: complete edited track
    edited_track = None

    db.edit_track(edited_track)

    return jsonify({'track': edited_track})
